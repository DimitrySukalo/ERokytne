...
public static class MessageHelper
{
    public static string GetRegistrationMessage()
    {
        ...
        message.Append("🌤 Погода:\n");
        message.Append("- Тут ви можете переглянути прогноз погоди в Рокитному на 3 дні вперед.\n" +
                       "Як переглянути прогноз?\n");
        message.Append(" \n");
        message.Append("<b>Погода -> Обираєте день -> Готово </b> ✅\n");
        message.Append(" \n");
